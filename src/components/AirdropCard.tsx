...
const AirdropCard = ({
  ...
  return <Link to={`/airdrop/${airdrop.slug}`} className="group">
      <Card className="h-full transition-all duration-300 hover:shadow-xl hover:scale-105 border-border/50 hover:border-primary/50 bg-card gradient-card overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/5 opacity-0 group-hover:divide-opacity-100 transition-opacity duration-300 bg-red-600" />
        ...
        <CardHeader className="relative">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center shadow-md p-2">
              <img src={airdrop.logoUrl} alt={`${airdrop.title} Logo`} className="w-full h-full object-contain" />
            </div>
